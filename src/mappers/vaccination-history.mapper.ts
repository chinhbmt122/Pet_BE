...
export class VaccinationHistoryMapper {
    static toDomain(entity: VaccinationHistory): VaccinationHistoryDomainModel {
        return VaccinationHistoryDomainModel.reconstitute({
            ...
            vaccineBoosterIntervalMonths: entity.vaccineType?.boosterIntervalMonths ?? null,
        });
    }

    static toPersistence(domain: VaccinationHistoryDomainModel): Partial<VaccinationHistory> {
    ...
    static toDomainList(entities: VaccinationHistory[]): VaccinationHistoryDomainModel[] {
