...
**Version:** 2.0  
**Date:** 27/12/2025  
**Authors:** SE100 Development Team (Group 9)
...
| Development Team | November 16, 2025 | Added payment gateway integration |
| Chinh | December 26, 2025 | Added Cage & Boarding, vaccination tracking |
| SE100 Team | December 27, 2025 | Updated to reflect actual implementation |
...
- [1.3 System Features](#13-system-features)
- [1.4 Data Requirements](#14-data-requirements)
- [1.5 External Interface Requirements](#15-external-interface-requirements)
- [1.6 Quality Attributes](#16-quality-attributes)
- [1.7 Other Requirements](#17-other-requirements)
- [1.8 Glossary](#18-glossary)
- [1.9 Analysis Models](#19-analysis-models)
...
### **1.3.1 Account Management and Authorization**
...
### **1.3.2 Pet and Owner Information Management**
...
### **1.3.3 Staff Schedule Management**
...
### **1.3.4 Service and Appointment Management**
...
### **1.3.5 Service Execution and Care Activities**
...
### **1.3.8 Cage and Boarding Management**
...
The system implements a **comprehensive relational database with 22 core entities** managed through TypeORM 0.3.28:
